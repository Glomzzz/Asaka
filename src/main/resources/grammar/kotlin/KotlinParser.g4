...
type
    : typeModifiers? (functionType | parenthesizedType | nullableType | TypeInsterence | definitelyNonNullableType)
    ;
...
nullableType
    : (TypeInsterence | parenthesizedType) NL* quest+
    ;
...
receiverType
    : typeModifiers? (parenthesizedType | nullableType | TypeInsterence)
    ;
